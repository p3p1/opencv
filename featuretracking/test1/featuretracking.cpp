/* Implementazione del Pyramid Lucas-Kanade optical flow method  
 * 
 */
// Librerie Necessarie 
...
void corner_ShiTomasi( int, void* )
{
  ...
  double qualityLevel = 0.5; // Impostazione del livello di qualità dei corners. 
